...
console.log('Intro component loaded with video prop:', props.video);
console.log('Intro props object:', props);

const sound = ref(false)
const audioEl = ref(null)
const videoElement = ref(null)

const videoPath = computed(() => `/videos/${props.video}.mp4`)
